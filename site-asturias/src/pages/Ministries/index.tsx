    ...
    >
      ...
      <MinistriesContainer>
        ...
        <TextBlock>
          ...
          <Image src="assets/logo/ucp_logo.webp" alt="Logotipo da União Presbiteriana de Crianças" />
          <Text>
        ...
        <TextBlock>
          ...
          <Image src="assets/logo/logo_saf.png" alt="Logotipo da Sociedade Auxiliadora Feminina" />
          <Text>
        ...
        <TextBlock>
          ...
          <Image src="assets/logo/logo_uph.png" alt="Logotipo da União Presbiteriana de Homens" />
          <Text>
        ...
        <TextBlock>
          ...
          <Image src="/assets/logo/logo_recepcao.webp" alt="Logotipo do Ministério de Recepção" />
          <Text>
        ...
        <TextBlock>
          ...
          <Image src="/assets/logo/logo_louvor.webp" alt="Logotipo do Ministério de Louvor" />
          <Text>
        ...
        <TextBlock>
          ...
          <Image src="/assets/logo/logo_comunicacao.webp" alt="Logotipo do Ministério de Comunicação" />
          <Text>
